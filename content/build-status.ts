...
export const buildStatus = buildStatusSchema.parse({
  ...
  completed: ["Vision narrative and brand-token system", "Interactive Career Radar demonstration", "Truth Gate and Application Pack simulations", "Roadmap and architecture content models", "Responsive documentation and Build Status surfaces"],
